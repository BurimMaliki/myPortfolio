  ...
  var I18N = {
    de: {
      ...
      'projects.title': 'Projekte',
          'projects.lead': 'Drei Projekte, drei Ansätze: eine Meal-Planning-App, ein spielbares Strategie-Spiel und das Konzept für eine Lernplattform.',
      ...
      'projects.rfFormulaCaption': 'Kampfformel (vereinfacht)',
          ...
          'projects.fsTag': 'App · Frontend',
          'projects.fsTitle': 'FoodSync',
          'projects.fsDesc': 'FoodSync ist eine Meal-Planning-App auf React-Basis: Demo-Profile mit Kalorien- und Makro-Zielen, dazu persönliche Empfehlungen, die Allergien und Ernährungsweisen wie vegetarisch berücksichtigen und zum verbleibenden Tagesbudget sortiert sind. Mahlzeiten lassen sich von Montag bis Sonntag in einen Wochenplan legen — inklusive Tages- und Wochen-Tracking der Kalorien, anpassbarem Kalorienziel und Berechnung nach Harris-Benedict. Aus allen geplanten Mahlzeiten entsteht automatisch eine kategorisierte Einkaufsliste mit zusammengeführten Mengen zum Ausdrucken.',
          'projects.fsChipsAria': 'Eigenschaften von FoodSync',
          'projects.fsChip1': 'React & JavaScript',
          'projects.fsChip2': 'Tailwind CSS',
          'projects.fsChip3': 'Wochenplan',
          'projects.fsChip4': 'Einkaufsliste',
          'projects.fsChip5': 'Harris-Benedict',
          'projects.fsTechLabel': 'Tech-Stack',
          'projects.fsTech': 'React · JavaScript · Tailwind CSS',
          'projects.fsStatusLabel': 'Status',
          'projects.fsStatus': 'Frontend-Prototyp mit Demo-Daten — ohne Backend und Datenbank. Änderungen bleiben nur gespeichert, solange die App geöffnet ist.',
          'projects.fsCta': 'FoodSync ansehen',
          'projects.fsCtaAria': 'FoodSync ansehen (neuer Tab)',
          'projects.fsVisualAria': 'FoodSync Features',
          'projects.fsStatsTitle': 'Tagesziel',
          'projects.fsStatCalories': 'Kalorien',
          'projects.fsStatProtein': 'Protein',
          'projects.fsStatCarbs': 'Kohlenhydrate',
          'projects.fsStatFat': 'Fette',
          'projects.fsWeekTitle': 'Wochenplan',
          'projects.fsDay1': 'Mo',
          'projects.fsDay2': 'Di',
          'projects.fsDay3': 'Mi',
          'projects.fsDay4': 'Do',
          ...
          'projects.fsDay6': 'Sa',
          'projects.fsDay7': 'So',
          'projects.fsWeekListAria': 'Wochenplan: Mahlzeiten pro Tag',
          'projects.fsWeekCaption': 'Wochenplan — Mahlzeiten pro Tag (Beispiel)',
          'projects.fsFormulaCaption': 'Kalorienbedarf nach Harris-Benedict (vereinfacht)',
          'projects.fsFormula': 'Grundumsatz = 66,5 + 13,75 × Gewicht (kg) + 5,003 × Grösse (cm) − 6,75 × Alter',
    ...
    en: {
      ...
      'projects.title': 'Projects',
          'projects.lead': 'Three projects, three approaches: a meal-planning app, a playable strategy game, and the concept for a learning platform.',
      ...
      'projects.rfFormulaCaption': 'Combat formula (simplified)',
          ...
          'projects.fsTag': 'App · Frontend',
          'projects.fsTitle': 'FoodSync',
          'projects.fsDesc': 'FoodSync is a React-based meal-planning app: demo profiles with calorie and macronutrient targets, plus personalised recommendations that respect allergies and dietary choices like vegetarian and are sorted by the remaining daily calorie budget. Meals can be added to a Monday-to-Sunday weekly plan — with daily and weekly calorie tracking, an editable calorie target, and calculation via the Harris-Benedict formula. All planned meals automatically generate a categorised shopping list with combined quantities, ready to print.',
          'projects.fsChipsAria': 'FoodSync features',
          'projects.fsChip1': 'React & JavaScript',
          'projects.fsChip2': 'Tailwind CSS',
          'projects.fsChip3': 'Weekly plan',
          'projects.fsChip4': 'Shopping list',
          'projects.fsChip5': 'Harris-Benedict',
          'projects.fsTechLabel': 'Tech stack',
          'projects.fsTech': 'React · JavaScript · Tailwind CSS',
          'projects.fsStatusLabel': 'Status',
          'projects.fsStatus': 'Frontend prototype with demo data — no backend or database. Changes are only kept while the app is open.',
          'projects.fsCta': 'View FoodSync',
          'projects.fsCtaAria': 'View FoodSync (new tab)',
          'projects.fsVisualAria': 'FoodSync features',
          'projects.fsStatsTitle': 'Daily target',
          'projects.fsStatCalories': 'Calories',
          'projects.fsStatProtein': 'Protein',
          'projects.fsStatCarbs': 'Carbs',
          'projects.fsStatFat': 'Fat',
          'projects.fsWeekTitle': 'Weekly plan',
          'projects.fsDay1': 'Mon',
          'projects.fsDay2': 'Tue',
          'projects.fsDay3': 'Wed',
          'projects.fsDay4': 'Thu',
          ...
          'projects.fsDay6': 'Sat',
          'projects.fsDay7': 'Sun',
          'projects.fsWeekListAria': 'Weekly plan: meals per day',
          'projects.fsWeekCaption': 'Weekly plan — meals per day (example)',
          'projects.fsFormulaCaption': 'Calorie needs via Harris-Benedict (simplified)',
          'projects.fsFormula': 'BMR = 66.5 + 13.75 × weight (kg) + 5.003 × height (cm) − 6.75 × age',
